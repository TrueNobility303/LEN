...
plt.plot(time_lst_LEAN_1, gnorm_lst_LEAN_1, ':r', label='EG-2', linewidth=3)
plt.plot(time_lst_LEAN_10, gnorm_lst_LEAN_10, '-k', label='LEN', linewidth=3)
